      ...
      {mobileOpen ? (
        <>
          ...
          <div
            ...
            className="scrollbar-themed fixed left-3 right-3 top-18 z-120 max-h-[min(72vh,calc(100dvh-6rem))] overflow-y-auto rounded-2xl border border-card-border bg-card p-2 text-foreground shadow-[0_24px_64px_rgba(15,23,42,0.12)] backdrop-blur-xl dark:bg-elevated dark:shadow-[0_24px_64px_rgba(0,0,0,0.35)] lg:hidden"
          >
