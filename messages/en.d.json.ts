...
declare const messages: {
  ...
  "video-edit": {
    ...
    "workspace": {
      ...
      "textPanel": {
        "srtStyleSyncHint": "Imported .srt captions: font, color, opacity, size, and position apply to every cue from the same import. Edit wording and timing per line below."
      },
      "subs": {
